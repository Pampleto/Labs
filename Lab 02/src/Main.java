...
public class Main {
    public static void main(String[] args) {
        ...
        Estudiante maria = new Estudiante("Maria Jesus", 20, "B65537354", "Medicina");
        maria.agregarNota(99.5);
        maria.agregarNota(64.0);
        maria.agregarNota(70.0);
        ...
        gestorEstudiantes.agregarTodos(ana, maria);
