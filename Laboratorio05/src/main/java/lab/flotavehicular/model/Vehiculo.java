...
public abstract class Vehiculo implements Mantenible {
    // 'protected': visible para las subclases (herencia), no para cualquiera
    ...
    // Constructor: recibe los datos básicos y asigna el estado inicial DISPONIBLE
    ...
    // Método abstracto: cada tipo de vehículo se mueve distinto (polimorfismo)
